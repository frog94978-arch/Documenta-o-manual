      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="mt-8">
          <h1 className="text-3xl font-bold mb-6 text-foreground">Área Patrimonial</h1>
                    <p className="text-muted-foreground text-lg mb-8">Com a área Patrimonial é possível o controle e gerenciamento dos processos de compras da instituição. Auxilia no cadastramento e controle de bens e da frota de veículos. Possibilita o gerenciamento e controle dos contratos e convênios. Também dispomos de diversos relatórios e consultas, a fim de garantir o gerenciamento patrimonial da instituição.</p>
